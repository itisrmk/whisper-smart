...
private extension WhisperRuntimeInstaller {
    ...
    func installManagedRuntime() throws -> String {
        ...
        let asset = RuntimeAsset(
            ...
            // Verified 2026-07-17. GitHub's autogenerated tag archives can be
            // regenerated with a different hash; if verification fails, hash
            // the fresh tarball (shasum -a 256) and update this constant.
